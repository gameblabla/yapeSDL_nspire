...
void TED::texttoscreen(int x,int y, char *scrtxt)
{
	register int i =0;
...
/*unsigned char TED::read_(unsigned int addr)
{
	return MainMemory->Handle(addr);
}*/
    ...
    do {
        switch(++beamx) {
            ...
            case 90:
				...
				else if ( VertSubActive && VertSubCount == 7 )
